...
class CardEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'facebook': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://www.facebook.com/seu-perfil'}),
            'instagram': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://www.instagram.com/seu-perfil'}),
            'linkedin': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://www.linkedin.com/in/seu-perfil/'}),
            'telefone': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '(11) 98754-3210'}),
            'youtube': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://www.youtube.com/seu-perfil/'}),
            'tik_tok': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://www.tiktok.com/seu-perfil/'}),
